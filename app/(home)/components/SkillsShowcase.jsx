...
import { FaNodeJs, FaPython, FaHtml5, FaCss3Alt, FaAndroid, FaWordpress } from 'react-icons/fa';
import { SiFlutter, SiDart, SiNextdotjs, SiCplusplus, SiCsharp, SiVisualstudiocode } from 'react-icons/si';

const skills = [
    { name: "Flutter", icon: <SiFlutter className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "Dart", icon: <SiDart className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Next.js", icon: <SiNextdotjs className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Node.js", icon: <FaNodeJs className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "WordPress", icon: <FaWordpress className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    ...
    { name: "C#", icon: <SiCsharp className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "HTML5", icon: <FaHtml5 className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "CSS3", icon: <FaCss3Alt className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Android Studio", icon: <FaAndroid className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
